...
//        System.out.println(myAtoi("+1"));
    ...
    /*
        ...
        Memory
        42.20MB
        Beats 66.34% of users with Java
     */
    public static int myAtoi(String s) {
        ...
        char currentChar;
        while(i < s.length() && (currentChar = s.charAt(i)) >= '0' && currentChar <= '9') {
        ...
        for(i = numbers.size() - 1; i >=0; i--) {
            number += (double)numbers.get(i) * multipilier;
            multipilier*=10;
        }
        if (minus) {
            number *= -1;
            return number < Integer.MIN_VALUE ? Integer.MIN_VALUE : (int) number;
        } else {
